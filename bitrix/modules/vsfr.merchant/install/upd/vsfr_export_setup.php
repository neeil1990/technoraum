...
//var_dump(file_exists($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/vsfr.merchant/mysql/vsfr_catalog_export.php"));
...
$arReportsList = GetReportsList(VSFRCATALOG_PATH2EXPORTS);
