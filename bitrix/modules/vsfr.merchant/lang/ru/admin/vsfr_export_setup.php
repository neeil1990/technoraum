...
$MESS["CES_NOTES1"] = "Для <b><u>автоматического запуска</u></b> нужно привязать задачу к cron, для этого в выпадающем меню для нужного профиля выберите пункт <i>Привязать к cron</i>. <br> Если по какой либо причине автоматический запуск задачи не сработал, привяжите задачу к cron вручную по инструкции: <a href=\"http://marketplace.1c-bitrix.ru/solutions/vsfr.merchant/#tab-install-link\" target=\"_blank\">Запуск через cron</a>";
...
$MESS["CES_NOTES11_EXT"] = "Оболочкой для выполнения задач на cron является файл:";
$MESS["CES_NOTES12_EXT"] = "Если задача на cron автоматически не сработала, убедитесь, что в файле cron_frame.php прописаны правильные пути к php и корню сайта в соответствии с инструкцией <a href=\"http://marketplace.1c-bitrix.ru/solutions/vsfr.merchant/#tab-install-link\" target=\"_blank\">Запуск через cron</a>";
