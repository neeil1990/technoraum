...
return [
	...
	'items' => [
		...
		'#block3361' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-left g-color-main g-font-montserrat',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation u-block-border u-block-border-margin-sm g-rounded-5 u-block-border-first l-d-xs-none g-mt-25 g-pt-5 animation-none animated g-bg-main container',
				],
			],
		],
		'#block3362' => [
		...
		'#block3359' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-left g-font-montserrat',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation u-block-border-first g-rounded-5 u-block-border u-block-border-margin-sm l-d-xs-none g-mt-25 g-pt-5 animation-none animated g-bg-main container',
				],
			],
		],
		'#block3360' => [
