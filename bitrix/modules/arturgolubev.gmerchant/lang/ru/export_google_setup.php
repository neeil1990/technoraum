<?
$MESS["ARTURGOLUBEV_GMERCHANT_DEMO_IS_EXPIRED"] = "Демо-период модуля закончился, для продолжения работы необходимо приобрести полную версию модуля в <a href=\"http://marketplace.1c-bitrix.ru/solutions/arturgolubev.gmerchant/\" target=\"_blank\">Marketplace 1c-Bitrix</a>";

$MESS["ARTURGOLUBEV_GMERCHANT_INFORMATION"] = "
<div style='margin-bottom:8px;'><b style='font-size:16px;'>Полезная информация</b></div>
...
Видео-инструкция - <a href='http://arturgolubev.ru/learning/course/index.php?COURSE_ID=2&INDEX=Y' target='_blank'>ссылка</a><br>
Часто задаваемые вопросы по данному модулю - <a href='http://arturgolubev.ru/learning/course/index.php?COURSE_ID=2&INDEX=Y' target='_blank'>ссылка</a><br>
Общие часто задаваемые вопросы - <a href='http://arturgolubev.ru/learning/course/?COURSE_ID=1&INDEX=Y' target='_blank'>ссылка</a>
</div>
";
...
$MESS["CAT_YANDEX_HIDE_WITHOT_PICTURES"] = "Скрыть товары без картинок";
$MESS["CAT_YANDEX_HIDE_WITHOT_DESCRIPTION"] = "Скрыть товары без описаний";
$MESS["CAT_GOOGLE_HIDE_QUANTITY_NULL"] = "Скрыть товары с нулевым Доступным количеством";


$MESS["CAT_GOOGLE_USE_PREVIEW_TEXT"] = "Использовать Описание для анонса<br> если отсутствует Детальное описание";
$MESS["CAT_GOOGLE_NO_USE_STANDART_PICTURES"] = "Не использовать Картинку для анонса и Детальную картинку";
$MESS["CAT_GOOGLE_NO_USE_STANDART_PICTURES_NOTE"] = "В качестве основого фото товара будет использована первая картинка поля additional_image_link";
$MESS["CAT_GOOGLE_ONLY_STANDART_PRICE"] = "Записывать цену со скидкой в параметр &lt;price&gt;";
$MESS["CAT_GOOGLE_ONLY_STANDART_PRICE_NOTE"] = "Данная настройка полезна при выгрузке в Facebook, который в отличии от Google не умеет обрабатывать параметр &lt;sale_price&gt;";

$MESS["BX_CATALOG_EXPORT_YANDEX_COMPANY_NAME"] = "Название фида данных";
$MESS["CAT_YANDEX_LOCK_CUPON_CHECK"] = "Отключить проверку купонов для скидок";
$MESS["CAT_YANDEX_LOCK_CUPON_CHECK_NOTE"] = "С помощью данной настройки можно отключить ресурсоёмкую проверку купонов, при использовании модуля на слабых хостингах";
