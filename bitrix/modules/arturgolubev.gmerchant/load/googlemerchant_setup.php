...
if (2 > $STEP)
{
	...
	<input type="hidden" name="SETUP_FIELDS_LIST" value="V,IBLOCK_ID,SITE_ID,SETUP_SERVER_NAME,COMPANY_NAME,COMPANY_DESCRIPTION,SETUP_FILE_NAME,XML_DATA,USE_HTTPS,HIDE_WITHOT_PICTURES,FILTER_AVAILABLE,DISABLE_REFERERS,MAX_EXECUTION_TIME,CHECK_PERMISSIONS">
