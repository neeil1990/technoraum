...
class VendorModel extends Xml\Format\Reference\Base
{
    ...
    public function getPromoProduct($type = null)
    {
        ...
        {
            $result->addAttribute(new Xml\Attribute\Base(['name' => 'category-id', 'value_type' => Type\Manager::TYPE_NUMBER, 'required' => true]));
        }
        else
        {
            $result->addAttribute(new Xml\Attribute\Base(['name' => 'offer-id', 'value_type' => Type\Manager::TYPE_NUMBER, 'required' => true]));
    ...
    public function getPromoGift($type = null)
    {
        ...
        {
            $result->addAttribute(new Xml\Attribute\Base(['name' => 'gift-id', 'value_type' => Type\Manager::TYPE_NUMBER]));
        }
        else
        {
            $result->addAttribute(new Xml\Attribute\Base(['name' => 'offer-id', 'value_type' => Type\Manager::TYPE_NUMBER]));
        }
    ...
    public function getGift()
    {
        return new Xml\Tag\Base([
            'name' => 'gift',
            'attributes' => [
                new Xml\Attribute\Base(['name' => 'id', 'value_type' => Type\Manager::TYPE_NUMBER, 'required' => true])
            ],
            'children' => [
