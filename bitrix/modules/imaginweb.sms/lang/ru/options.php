...
$MESS["IMAGINWEB_SMS_IMEET_PRAMYE_PODKLUC"] = "имеет прямые подключения к федеральным операторам сотовой связи — «МТС», «Билайн», «Мегафон».<br><br>
&mdash; Более 10 лет на рынке;<br>
&mdash; Высокое качество и низкая стоимость;<br>
&mdash; Бесплатное тестирование;<br>
&mdash; Интеграции со всеми платформами;<br>
&mdash; Персональный менеджер;<br>
&mdash; Мобильная реклама;<br>
&mdash; Email рассылки;<br>
&mdash; Viber рассылки;<br>
&mdash; SMS рассылки;<br>
&mdash; Техническая поддержка 24х7.";
...
$MESS["IMAGINWEB_SMS_ODNA_IZ_SAMYH_NIZKIH"] = "Одна из самых низких цен за СМС! ";
...
$MESS["IMAGINWEB_SMS_ODNA_IZ_SAMYH_NIZKIH2"] = "Одна из самых низких цен за СМС! Специальная цена для пользователей модуля!";
...
$MESS["IMAGINWEB_SMS_ODNA_IZ_SAMYH_NIZKIH3"] = "Одна из самых низких цен за СМС! Специальная цена для пользователей модуля!";
...
$MESS["IMAGINWEB_SMS_DLA_PODKLUCENIA_TARI"] = "Для подключения специального тарифа, Ваш код приглашения - Имейджин Вэб";
$MESS["IMAGINWEB_SMS_V_STADII_TESTIROVANI"] = "В стадии тестирования!!!";
$MESS["IMAGINWEB_SMS_DLA_PODKLUCENIA_TARI1"] = "Для подключения специального тарифа, Ваш код приглашения - Имейджин Вэб или";
...
$MESS["IMAGINWEB_SMS_BOLEE_REALIZOVAN"] = "Более 150 реализованных проектов";
$MESS["IMAGINWEB_SMS_STAT_SPECIALISTOV_S"] = "Штат специалистов, с опытом работы от 5 лет";
$MESS["IMAGINWEB_SMS_SOBSTVENNAA_PLATFORM"] = "Собственная платформа для обработки трафика";
$MESS["IMAGINWEB_SMS_SOBSTVENNAA_KOMANDA"] = "Собственная команда разработчиков";
$MESS["IMAGINWEB_SMS_TEHNICESKAA_PODDERJK"] = "Техническая поддержка 24х7";
$MESS["IMAGINWEB_SMS_NAVIGATOR_V_MIRE_MOB"] = "НАВИГАТОР В МИРЕ МОБИЛЬНЫХ КОММУНИКАЦИЙ";
$MESS["IMAGINWEB_SMS_BOLEE_REALIZOV"] = "• Более 150 реализованных проектов;";
$MESS["IMAGINWEB_SMS_RASSYLKA_PO_VSEMU"] = "• Рассылка по всему миру;";
$MESS["IMAGINWEB_SMS_GARANTIROVANNAA_BE"] = "• Гарантированная безопасность;";
$MESS["IMAGINWEB_SMS_PROSTAA_INTEGRACIA"] = "• Простая интеграция;";
$MESS["IMAGINWEB_SMS_INDIVIDUALQNYY_POD"] = "• Индивидуальный подход;";
$MESS["IMAGINWEB_SMS_PERSONALQNYY_MENED"] = "• Персональный менеджер;";
$MESS["IMAGINWEB_SMS_BESPLATNYE_MARKETI"] = "• Бесплатные маркетинговые консультации и помощь в запуске рекламных кампаний;";
$MESS["IMAGINWEB_SMS_STAT_SPECIALISTOV"] = "• Штат специалистов, с опытом работы от 5 лет;";
$MESS["IMAGINWEB_SMS_SOBSTVENNAA_PLATFO"] = "• Собственная платформа для обработки трафика;";
$MESS["IMAGINWEB_SMS_SOBSTVENNYH"] = "• 2 собственных SMS-центра;";
$MESS["IMAGINWEB_SMS_SOBSTVENNAA_KOMAND"] = "• Собственная команда разработчиков;";
$MESS["IMAGINWEB_SMS_TEHNICESKAA_PODDER"] = "• Техническая поддержка 24х7;";
$MESS["IMAGINWEB_SMS_PRAMYE_PODKLUCENIA"] = "• Прямые подключения к операторам сотовой связи;";
$MESS["IMAGINWEB_SMS_DOLGOSROCNYE_KONTR"] = "• Долгосрочные контракты.";
$MESS["IMAGINWEB_SMS_TIP_OTPRAVKI_SMS"] = "Тип отправки, смс, viber:
						";
$MESS["IMAGINWEB_SMS_IMA_OTPARVITELA_DOLJ"] = "Имя отпарвителя должно быть разрешено в личном кабинете!!!:";
$MESS["IMAGINWEB_SMS_KLUC1"] = "ключ:";
$MESS["IMAGINWEB_SMS_IMA_OTPRAVITELA_DOLJ"] = "Имя отправителя должно быть разрешено в личном кабинете!!!:";
$MESS["IMAGINWEB_SMS_VREMA_JIZNI_SOOBSENI"] = "Время жизни сообщения(сек) для viber";

$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_1"] = "Низкие цены на Россию от 25 копеек, Украина от 22 копеек. Cтабильный сервис, 50 SMS для тестирования.";
$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_2"] = "- Предоставление персонального менеджера";
$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_3"] = "- Простой и удобный интерфейс";
$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_4"] = "- Техническая поддержка 24/7";
$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_5"] = "- Доставка сообщений в любую точку мира";
$MESS["IMAGINWEB_SMS_INTEL_TELE_COM_6"] = "- Прямые договора с операторами";
$MESS['IMAGINWEB_SMS_TARGETSMS_INFO'] = "<a target='_blank' href='https://targetsms.ru'>TargetSMS.ru</a> &mdash; рассылка СМС для Вашего бизнеса:<br><br>
									&mdash; Регистрация Вашего имени отправителя бесплатно;<br>
									&mdash; Гарантия доставки на активные телефонные номера;<br>
									&mdash; Отправка СМС-сообщений на российские, украинские, белорусские, казахстанские номера телефонов (а также весь Мир);<br>
									&mdash; Бесплатное тестирование;<br>
									&mdash; Техническая поддержка 24/7/365;<br>
									&mdash; Официальные каналы отправки СМС-сообщений;<br>
									&mdash; Подробные статусы доставки СМС-сообщений.<br><br>
									Регистрация в сервисе <a target='_blank' href='https://sms.targetsms.ru/ru/reg.html?ref=1cbitrix_imaginweb'>TargetSMS.ru</a>";
?>