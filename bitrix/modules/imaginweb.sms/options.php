		...
		<tr>
			...
			<td width="50%">
				<select name="settings[gate]">
					...
					<option value="targetsms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'targetsms.ru'))?' selected="selected"':''?>>targetsms.ru</option>
					<option value="axtele.com" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'axtele.com'))?' selected="selected"':''?>>axtele.com</option>
					<option value="intel-tele.com" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'intel-tele.com'))?' selected="selected"':''?>>intel-tele.com</option>
					<option value="easy-sms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'easy-sms.ru'))?' selected="selected"':''?>>easy-sms.ru</option>
					...
					<option value="p1sms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'p1sms.ru'))?' selected="selected"':''?>>p1sms.pro</option>
					...
					<option value="redsms.ru3.0" <?=((COption::GetOptionString('imaginweb.sms', 'gate') == 'redsms.ru3.0'))?' selected="selected"':''?>>redsms.ru 3.0</option>
		...
		<? foreach($arSites as $id => $value):?>
					...
					<tr>
						...
						<td width="50%">
							<select name="settings[gate<?=$id?>]">
								...
								<option value="targetsms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'targetsms.ru'))?' selected="selected"':''?>>targetsms.ru</option>
								<option value="axtele.com" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'axtele.com'))?' selected="selected"':''?>>axtele.com</option>
								<option value="intel-tele.com" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'intel-tele.com'))?' selected="selected"':''?>>intel-tele.com</option>
								<option value="easy-sms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'easy-sms.ru'))?' selected="selected"':''?>>easy-sms.ru</option>
								...
								<option value="p1sms.ru" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'p1sms.ru'))?' selected="selected"':''?>>p1sms.pro</option>
								...
								<option value="redsms.ru3.0" <?=((COption::GetOptionString('imaginweb.sms', 'gate'.$id) == 'redsms.ru3.0'))?' selected="selected"':''?>>redsms.ru 3.0</option>
			...
			<? if(CModule::IncludeModule("sale")) :?>
				<table class="edit-table">
					...
					<tr class="heading">
						<td colspan="2">���������� ��� ����������� ������������ (�������: #LOGIN# - �����, #PASSWORD# - ������, #EMAIL# - email, #NAME# - ���, #LAST_NAME# - �������, #SECOND_NAME# - ���������.)</td>
					</tr>
					<tr>
						<td width="50%" class="field-name">����������� ������������<span style="color: red;">**</span></td>
						<td width="50%">
					...
					<tr class="heading">
						<td colspan="2"><a class="toggle-link" href="javascript:iwebtoggle('add_phone_user_register<?=$id?>');iwebtoggle('order_user_register_2<?=$id?>');">�������������� ��������� ��� ����������� ������������</a></td>
					</tr>
					   */?>
				</td>
				</table>
...
<?=GetMessage("IMAGINWEB_SMS_DLA_RABOTY_TREBUETSA")?> OpenSSL <?=GetMessage("IMAGINWEB_SMS_I_ODNO_IZ_DVUH_RASSI")?>: SOAP <?=GetMessage("IMAGINWEB_SMS_ILI")?> cURL. 
	...
	<!--targetsms.ru-->
		<tr class="heading gateLinkHead">
			<td colspan="2"><a class="toggle-link gateControll-new" ref="targetsms" href="javascript:iwebtoggle('targetsms')">TargetSMS.ru</a></td>
		</tr>
		
		<tr class="sites gateShow targetsms" id="targetsms" style="display: none;">
			<td colspan="2">
				<table class="edit-table">
					<tr class="heading">
					...
					<tr>
						<td colspan="2">
							<div class="tab-text">
								<p class='iweb-medium'>
									<?=GetMessage("IMAGINWEB_SMS_TARGETSMS_INFO")?>
								</p>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td width="50%">
							<input
								type="text"
								size="30"
								value="<?=COption::GetOptionString('imaginweb.sms', 'originator_targetsms')?>"
								name="settings[originator_targetsms]" />
						</td>
					</tr>
					<tr class="heading">
					...
					<tr>
						...
						<td width="50%">
						    <input
							    type="text"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'login_targetsms') ?>"
							    name="settings[login_targetsms]" />
						</td>
					</tr>
					<tr>
						...
						<td width="50%">
						    <input
							    type="password"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'pass_targetsms')?>"
							    name="settings[pass_targetsms]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><strong><?=GetMessage("IMAGINWEB_SMS_BALANS_RUBLEY")?></strong></td>
						<td width="50%" tlogin="login_targetsms"  class="balance" gate="targetsms.ru"></td>
					</tr>
				</table>
			</td>
		</tr>
...
<!--intel-tele.com-->
		<tr class="heading gateLinkHead">
			<td colspan="2"><a class="toggle-link gateControll-new" ref="intel-tele.com"  href="javascript:iwebtoggle('intel-tele.com')">intel-tele.com</a></td>
		</tr>
		
		<tr class="sites gateShow intel-tele.com" id="intel-tele.com" style="display: none;">
			<td colspan="2">
				<table class="edit-table">
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_PODKLUCENI")?></td>
					...
					<tr>
						<td colspan="2">
							<div class="tab-text">
								<p class='iweb-medium'>
									<p><a href="http://intel-tele.com/" target="_blank">Intel-Tele.com</a> - <?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_1")?></p>
									<p>
    									<?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_2")?><br>
    									<?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_3")?><br>
    									<?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_4")?><br>
    									<?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_5")?><br>
    									<?=GetMessage("IMAGINWEB_SMS_INTEL_TELE_COM_6")?><br>
									</p>
								</p>
							</div>
						</td>
					...
					<tr>
						...
						<td width="50%">
							<input
								type="text"
								size="30"
								value="<?=(COption::GetOptionString('imaginweb.sms', 'originator_intel-tele.com'))?COption::GetOptionString('imaginweb.sms', 'originator_intel-tele.com'):'' ?>"
								name="settings[originator_intel-tele.com]" />
						</td>
					</tr>
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_DOSTUPA")?></td>
					...
					<tr>
						...
						<td width="50%">
						    <input
							    type="text"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'username_intel-tele.com') ?>"
							    name="settings[username_intel-tele.com]" />
						</td>
					</tr>
					<tr>
						...
						<td width="50%">
						    <input
							    type="password"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'password_intel-tele.com')?>"
							    name="settings[password_intel-tele.com]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><strong><?=GetMessage("IMAGINWEB_SMS_BALANS_RUB")?></strong></td>
						<td width="50%" tlogin=""  class="balance" gate="intel-tele.com"></td>
					</tr>
				</table>
			</td>
		</tr>
<!--easy-sms.ru-->
		<tr class="heading gateLinkHead">
			<td colspan="2"><a class="toggle-link gateControll-new" ref="easy-sms.ru"  href="javascript:iwebtoggle('easy-sms.ru')">easy-sms.ru</a></td>
		</tr>
		
		<tr class="sites gateShow easy-sms.ru" id="easy-sms.ru" style="display: none;">
			<td colspan="2">
				<table class="edit-table">
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_PODKLUCENI")?></td>
					...
					<tr>
						<td colspan="2">
							<div class="tab-text">
								<p class='iweb-medium'>
									<p>-- http://easy-sms.ru/ - <?=GetMessage("IMAGINWEB_SMS_NAVIGATOR_V_MIRE_MOB")?></p>
									 
									<p><?=GetMessage("IMAGINWEB_SMS_BOLEE_REALIZOV")?><br>
									<?=GetMessage("IMAGINWEB_SMS_RASSYLKA_PO_VSEMU")?><br>
									<?=GetMessage("IMAGINWEB_SMS_GARANTIROVANNAA_BE")?><br>
									<?=GetMessage("IMAGINWEB_SMS_PROSTAA_INTEGRACIA")?><br>
									<?=GetMessage("IMAGINWEB_SMS_INDIVIDUALQNYY_POD")?><br>
									<?=GetMessage("IMAGINWEB_SMS_PERSONALQNYY_MENED")?><br>
									<?=GetMessage("IMAGINWEB_SMS_BESPLATNYE_MARKETI")?><br>
									<?=GetMessage("IMAGINWEB_SMS_STAT_SPECIALISTOV")?><br>
									<?=GetMessage("IMAGINWEB_SMS_SOBSTVENNAA_PLATFO")?><br>
									<?=GetMessage("IMAGINWEB_SMS_SOBSTVENNYH")?><br>
									<?=GetMessage("IMAGINWEB_SMS_SOBSTVENNAA_KOMAND")?><br>
									<?=GetMessage("IMAGINWEB_SMS_TEHNICESKAA_PODDER")?><br>
									<?=GetMessage("IMAGINWEB_SMS_PRAMYE_PODKLUCENIA")?><br>
									<?=GetMessage("IMAGINWEB_SMS_DOLGOSROCNYE_KONTR")?></p>
								</p>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td width="50%">
							<input
								type="text"
								size="30"
								value="<?=(COption::GetOptionString('imaginweb.sms', 'originator_easy-sms.ru'))?COption::GetOptionString('imaginweb.sms', 'originator_easy-sms.ru'):'test' ?>"
								name="settings[originator_easy-sms.ru]" />
						</td>
					</tr>
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_DOSTUPA")?></td>
					...
					<tr>
						...
						<td width="50%">
						    <input
							    type="text"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'username_easy-sms.ru') ?>"
							    name="settings[username_easy-sms.ru]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><?=GetMessage("IMAGINWEB_SMS_PAROLQ")?></td>
						<td width="50%">
						    <input
							    type="password"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'password_easy-sms.ru')?>"
							    name="settings[password_easy-sms.ru]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><strong><?=GetMessage("IMAGINWEB_SMS_BALANS_RUB")?></strong></td>
						<td width="50%" tlogin=""  class="balance" gate="easy-sms.ru"></td>
					</tr>
				</table>
			</td>
		</tr>
...
<!--p1sms.ru-->
		<tr class="heading gateLinkHead">
			<td colspan="2"><a class="toggle-link gateControll-new" ref="p1sms.ru"  href="javascript:iwebtoggle('p1sms.ru')">p1sms.pro</a></td>
		</tr>
		...
		<tr class="sites gateShow p1sms.ru" id="p1sms.ru" style="display: none;">
			<td colspan="2">
				<table class="edit-table">
					...
					<tr>
						<td colspan="2">
							<div class="tab-text">
								...
								<p class='iweb-medium'>
									<a href="http://p1sms.pro/" target="_blank">p1sms.pro</a> <?=GetMessage("IMAGINWEB_SMS_ETO_SERVIS_SMS_RAS")?> 1C-BITRIX <?=GetMessage("IMAGINWEB_SMS_VY_SMOJETE_INTEGRIRO")?>.
								</p>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td width="50%">
						    <input
							    type="text"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'apikey_p1sms.ru') ?>"
							    name="settings[apikey_p1sms.ru]" />
						</td>
					</tr>
					<?/*<tr>
						<td width="50%"><?=GetMessage("IMAGINWEB_SMS_LOGIN")?></td>
					...
					<tr>
						<td width="50%"><strong><?=GetMessage("IMAGINWEB_SMS_BALANS_RUB")?></strong></td>
						<td width="50%" tlogin="apikey_p1sms.ru" class="balance" gate="p1sms.ru"></td>
					</tr>
				</table>
			</td>
		</tr>
		<!--redsms.ru3.0-->
		<tr class="heading gateLinkHead">
			<td colspan="2"><a class="toggle-link gateControll-new" ref="redsms.ru3.0"  href="javascript:iwebtoggle('redsms.ru3.0')">redsms.ru 3.0</a></td>
		</tr>
		
		<tr class="sites gateShow redsms.ru3.0" id="redsms.ru3.0" style="display: none;">
			<td colspan="2">
				<table class="edit-table">
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_PODKLUCENI")?></td>
					...
					<tr>
						<td width="50%">
							<?=GetMessage("IMAGINWEB_SMS_TIP_OTPRAVKI_SMS")?></td>
						<td width="50%">
							<select name="settings[resend_type_redsms_3]">
								<option value="sms" <?=((COption::GetOptionString('imaginweb.sms', 'resend_type_redsms_3') == 'sms'))?' selected="selected"':''?>>sms</option>
								<option value="viber" <?=((COption::GetOptionString('imaginweb.sms', 'resend_type_redsms_3') == 'viber'))?' selected="selected"':''?>>viber</option>
								<option value="viber,sms" <?=((COption::GetOptionString('imaginweb.sms', 'resend_type_redsms_3') == 'viber,sms'))?' selected="selected"':''?>>viber,sms</option>
							</select>
						</td>
					</tr>
					<tr>
						<td width="50%"><?=GetMessage("IMAGINWEB_SMS_VREMA_JIZNI_SOOBSENI")?></td>
						<td width="50%">
							<input
								type="text"
								size="30"
								value="<?=(COption::GetOptionString('imaginweb.sms', 'viber_validity_redsms.ru3.0'))?COption::GetOptionString('imaginweb.sms', 'viber_validity_redsms.ru3.0'):'86400' ?>"
								name="settings[viber_validity_redsms.ru3.0]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><?=GetMessage("IMAGINWEB_SMS_POLE_OTPRAVITELA_BU")?> <br/> <?=GetMessage("IMAGINWEB_SMS_IMA_OTPRAVITELA_DOLJ")?></td>
						<td width="50%">
							<input
								type="text"
								size="30"
								value="<?=(COption::GetOptionString('imaginweb.sms', 'originator_redsms.ru3.0'))?COption::GetOptionString('imaginweb.sms', 'originator_redsms.ru3.0'):'REDSMS.RU' ?>"
								name="settings[originator_redsms.ru3.0]" />
						</td>
					</tr>
					<tr class="heading">
						<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_NASTROYKI_DOSTUPA")?></td>
					...
					<tr>
						...
						<td width="50%">
						    <input
							    type="text"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'username_redsms.ru3.0') ?>"
							    name="settings[username_redsms.ru3.0]" />
						</td>
					</tr>
					<tr>
						<td width="50%">API <?=GetMessage("IMAGINWEB_SMS_KLUC1")?></td>
						<td width="50%">
						    <input
							    type="password"
							    size="30"
							    value="<?=COption::GetOptionString('imaginweb.sms', 'password_redsms.ru3.0')?>"
							    name="settings[password_redsms.ru3.0]" />
						</td>
					</tr>
					<tr>
						<td width="50%"><strong><?=GetMessage("IMAGINWEB_SMS_BALANS_RUB")?></strong></td>
						<td width="50%" tlogin=""  class="balance" gate="redsms.ru3.0"></td>
					</tr>
				</table>
			</td>
		</tr>
