...
$MESS ['IPOLSDEK_OPT_ymapsAPIKey'] = "API-ключ Яндекс.карт  <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-ymapsAPIKey\", this);'></a>";
...
$MESS['IPOLSDEK_OPT_useOldWidjetConnect'] = "Использовать старое подключение виджета <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-useOldWidjetConnect\", this);'></a>";
	// Прочее
...
$MESS['IPOLSDEK_OPT_debugMode'] = "Включить режим отладки <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-debugMode\", this);'></a>";
	// Отладка
$MESS['IPOLSDEK_OPT_debug_widget'] = "Вывод расчетов виджета в консоль <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-debug_widget\", this);'></a>";
$MESS['IPOLSDEK_OPT_debug_startLogging'] = "Включить логирование в файл <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-startLogging\", this);'></a>";
$MESS['IPOLSDEK_OPT_debug_fileMode'] = "Режим записи файла лога <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-debug_fileMode\", this);'></a>";
	$MESS['IPOLSDEK_OPT_debug_fileMode_w'] = "Перезапись";
	$MESS['IPOLSDEK_OPT_debug_fileMode_a'] = "Добавление";
$MESS['IPOLSDEK_OPT_debug_calculation'] = "Калькуляция СДЭКа <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-debug_calculation\", this);'></a>";
$MESS['IPOLSDEK_OPT_debug_turnOffWidget'] = "Отключить калькуляцию виджета <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-debug_turnOffWidget\", this);'></a>";
...
$MESS ['IPOLSDEK_HELPER_useOldWidjetConnect'] = "Если при обновлении модуля слетела корректная работа виджета, или же работа кастомного функционала - поставьте этот флаг.";
