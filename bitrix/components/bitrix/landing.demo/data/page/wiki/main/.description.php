...
return [
	...
	'items' => [
		...
		'#block3349' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-center g-font-montserrat g-font-size-50',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp container g-pt-30 g-pb-4',
				],
			],
		],
		'#block3353' => [
		...
		'#block3419' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pl-0 g-pt-20 g-pb-auto container g-max-width-container',
				],
			],
		],
		'#block3350' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pt-50 g-pb-50 g-pl-5 g-pr-5',
				],
			],
		],
		'#block3418' => [
		...
		'#block3422' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-left g-font-montserrat g-font-size-38',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pl-0 g-pt-20 g-pb-auto container g-max-width-container',
				],
		...
		'#block3424' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-left g-font-montserrat g-font-size-22',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pl-0 g-pb-auto g-pt-25 container g-max-width-container',
				],
			],
		],
		'#block3425' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-400 g-my-0 text-left g-font-montserrat g-font-size-17',
				],
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pl-0 g-pb-auto g-pt-auto container g-max-width-container',
				],
			],
		],
		'#block3420' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pr-5 g-pt-4 g-pb-20 g-pl-auto',
				],
			],
		],
		'#block3426' => [
			...
			'style' => [
				...
				'#wrapper' => [
					0 => 'landing-block js-animation fadeInUp g-pb-50 g-pr-5 g-pt-auto g-pl-auto',
				],
			],
		],
	],
