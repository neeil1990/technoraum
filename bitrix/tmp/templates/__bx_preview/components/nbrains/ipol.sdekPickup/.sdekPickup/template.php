			...
			var IPOLSDEK_pvz = {
				...
				Y_markPVZ: function(){
					for(var i in IPOLSDEK_pvz.cityPVZ){
						...
						baloonHTML += "<a style='display: block;padding: 10px 12px;font-size: 12px;font-weight: bold;margin: auto 10px;' class='button' href='?action=BUY&id=<?=$arParams[PRODUCT_ID]?>'>Добавить в корзину</a>";
						baloonHTML += "</div>";
