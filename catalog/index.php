...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			5 => "POWER",
			6 => "PERFORMENCE",
			7 => "PARAMETRY_EHLEKTROSETI",
			8 => "AVTONOMNYJ",
			9 => "CLEANING_AREA",
			10 => "MOSHCHOST_VSASYVANIYA",
			11 => "MAKS_MOSHCHNOST_L_S",
			12 => "MAKS_PROIZVODIT_L_MIN",
			13 => "MAKS_PROIZVODIT_M3_CH",
			14 => "SOVMESTIMAYA_TEKHNIKA",
			15 => "PODOGREV_VODY",
			16 => "MAKS_MOSHCHNOST_KVT",
			17 => "NOMIN_MOSHNOST_KVT",
			18 => "TIP_PITANIA",
			19 => "INVERTORNYE",
			20 => "MAKS_RAZMER_CHASTIC_MM",
			21 => "DIAMETR_PATRUBKA_MM",
			22 => "VYSTOTA_PODACHI_M",
			23 => "ELEKTROSTARTER",
			24 => "OBEM_BAKA_L",
			25 => "DVIGATEL",
			26 => "VES_KG",
			27 => "GABARITY_SM",
			28 => "OBLAST_PREMENENIIA",
			29 => "DOPOLNITELNAYA_INFORMACIYA",
			30 => "PROF_PYLESOS",
			31 => "COMPLETE_MONOBLOKA",
			32 => "KOMPLEKTACIYA_NASOSA",
			33 => "KOMPLEKTACIYA_PENOGENERATORA",
			34 => "Komplektaciya_polomoechnoj_mashiny",
			35 => "Komplektaciya_podmetalnyh_mashiny",
			36 => "A_PYLESOSA",
			37 => "KOMPLEKTASIYA_STEKLOOCHISTITELYA",
			38 => "KOMPLEKTUYUSHCHIE_PODMETALNYH_MASHIN",
			39 => "ONASHCHENIE",
			40 => "RABOCHEE_DAVLENIE",
			41 => "CHARACTERISTIC",
			42 => "APPLICATION",
			43 => "COMPLETE_PAR",
			44 => "KOMPLEKTACIYA_AVD",
			45 => "COMPLETE",
			46 => "PROIZVODITELNOST",
